...
if(isset($_GET['coupon_status']) && $_GET['coupon_status']!=""){
  $coupon_status = $_GET['coupon_status'];
    ...
    <div class="col-md-2">
         ...
         'data-provide' => "datepicker", 'data-date-format' => "dd-mm-yyyy",'required'=>false])->label('Coupon Start Date') ?>
    </div>
    <div class="col-md-2">  
     <?php
         // echo "<pre>"; print_r($array1); die;
     ?>
       <?= $form->field($model, 'reg_no')->dropDownList(['C'=>'Closed','P'=>'Pending'],['prompt'=>'Select', 'name'=>'coupon_status', 'required'=>true, 'value'=>$coupon_status, 'id'=>'coupon_status','style'=>'width:150px;'])->label('Coupon Status') ;?>
</div>
  ...
  <div class="col-md-2">  
   ...
   <div class="col-md-2">  
    <?php $models= ClientMaster::find()->where(["status"=>"Active"])->AsArray()->all();
     ...
     ?>
       <?= $form->field($model, 'reg_no')->dropDownList($list2,['prompt'=>'Select','data-live-search'=>'true','data-style'=>"btn-default btn-custom1", 'name'=>'client', 'value'=>$client, 'id'=>'client','style'=>'width:160px;'])->label('Client') ;?>
</div>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="col-md-4" style="margin-top: 25px;">
          ...
          <div class="col-md-3" style="margin-top: 25px; width: 27%;">
 ...
 <?= Html::a('<i class="fa fa-fw fa-refresh "></i> Reset', ['coupon-report'], ['class' => 'btn btn-default']) ?>
</div>
...
<div class="col-md-2" style="margin-top: 25px;">
 ...
 $('body').on('click', '.download',function() {
  ...
  //alert(branch);
  if(coupon_status==""){
    alert('Coupon Status is Required'); return false;
  }else{
    window.location = '<?php echo Yii::$app->homeUrl .'?r=vehicle-master/coupon-report&fromdate='; ?>'+from+'&todate='+to+'&reg_no='+reg_no+'&client='+client+'&superviser='+supervisor+'&coupon_status='+coupon_status;
  }
});
